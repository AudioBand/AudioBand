    ...
    public class SettingsV3ToSettingsV4Profile : Profile
    {
        ...
        public SettingsV3ToSettingsV4Profile()
        {
            ...
            CreateMap<KeyValuePair<string, ProfileV3>, UserProfile>()
                ...
                .ForMember(dest => dest.ForegroundGradientColor, opt => opt.MapFrom(src => src.Value.ForegroundGradientColorSettings))
                .ForMember(dest => dest.ProgressBarThumbColor, opt => opt.MapFrom(src => src.Value.ProgressBarThumbColorSettings))
                .ForMember(dest => dest.ThumbBorderColor, opt => opt.MapFrom(src => src.Value.ThumbBorderColorSettings))
                ...
                .ForMember(dest => dest.LikeButton, opt => opt.MapFrom(src => new LikeButton()));
        }
    }
}
