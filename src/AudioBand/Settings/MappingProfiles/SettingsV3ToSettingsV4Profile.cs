    ...
    public class SettingsV3ToSettingsV4Profile : Profile
    {
        ...
        public SettingsV3ToSettingsV4Profile()
        {
            ...
            CreateMap<KeyValuePair<string, ProfileV3>, UserProfile>()
                ...
                .ForMember(dest => dest.ForegroundGradientColor, opt => opt.MapFrom(src => new UserProfile()))
                .ForMember(dest => dest.ProgressBarThumbColor, opt => opt.MapFrom(src => new UserProfile()))
                .ForMember(dest => dest.ThumbBorderColor, opt => opt.MapFrom(src => new UserProfile()))
